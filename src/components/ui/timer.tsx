...
export const Timer = ({ 
  ...
  const sizeClasses = size === 'large' 
    ? 'text-4xl font-black px-8 py-4 rounded-2xl border-2'
    : 'text-sm font-semibold px-3 py-2 rounded-full border';
  ...
  return (
    <div className={`relative flex items-center ${className}`}>
      ...
      {/* Timer principal */}
      <div className={`inline-block backdrop-blur-md transition-all duration-500 ${sizeClasses} ${
        showPenaltyAnimation 
